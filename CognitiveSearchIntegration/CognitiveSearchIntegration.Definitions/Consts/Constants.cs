namespace Microsoft.CognitiveSearchIntegration.Definitions.Consts
{
    public class Constants
    {
        public const string CognitiveSearchApiVersion = "2020-06-30";
        public const string CognitiveSearchApiVersionHeader = "api-version";
